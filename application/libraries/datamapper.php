...
class DataMapper implements IteratorAggregate {
	...
	protected function _where($key, $value = NULL, $type = 'AND ', $escape = NULL)
	{
		...
		foreach ($key as $k => $v)
		{
			...
			$this->db->where($new_k, $v, $this->_get_prepend_type($type), $escape); //hack - corrigir _where
		}
